...
export const handlers = [
  http.get(
    "https://metrics.ds4g.dev:38081/api/v1/db/data/noco/ds4g-data/Tracky-Position-Phase/views/Tracky-Position-Phase",
    ({ request }) => {
  ...
  http.get(
    "https://metrics.ds4g.dev:38081/api/v1/db/data/noco/ds4g-data/Tracky-Subproject-Phase/views/Tracky-Subproject-Phase",
    ({ request }) => {
      switch (new URL(request.url).searchParams.get("where")) {
  ...
  http.get(
    "https://metrics.ds4g.dev:38081/api/v1/db/data/noco/ds4g-data/Tracky-Phase/views/Tracky-Phase",
    () => {
      return HttpResponse.json(require("./stubs/nocodb/Tracky-Phase.json"));
    },
  ),
  http.get(
    "https://metrics.ds4g.dev:38081/api/v1/db/data/v1/ds4g-data/Tracky-Task",
    () => {
