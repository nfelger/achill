...
[![Pipeline](https://github.com/digitalservicebund/achill/actions/workflows/pipeline.yml/badge.svg)](https://github.com/digitalservicebund/achill/actions/workflows/pipeline.yml)
[![Scan](https://github.com/digitalservicebund/achill/actions/workflows/scan.yml/badge.svg)](https://github.com/digitalservicebund/achill/actions/workflows/scan.yml)
[![Secrets Check](https://github.com/digitalservicebund/achill/actions/workflows/secrets-check.yml/badge.svg)](https://github.com/digitalservicebund/achill/actions/workflows/secrets-check.yml)
...
🇬🇧
Everyone is welcome to contribute the development of the _achill_. You can contribute by opening pull request,
providing documentation or answering questions or giving feedback. Please always follow the guidelines and our
[Code of Conduct](CODE_OF_CONDUCT.md).

🇩🇪
Jede:r ist herzlich eingeladen, die Entwicklung der _achill_ mitzugestalten. Du kannst einen Beitrag leisten,
